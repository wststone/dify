...
const ActivateForm = () => {
  ...
  const defaultLanguage = languageMaps["zh-Hans"];
    ...
    >
      ...
      {checkRes && checkRes.is_valid && !showSuccess && (
        <div className="flex flex-col md:w-[400px]">
          <div className="w-full mx-auto">
            <div
              className={`mb-3 flex justify-center items-center w-20 h-20 p-5 rounded-[20px] border border-gray-100 shadow-lg text-[40px] font-bold ${style.logo}`}
            ></div>
            <h2 className="text-[32px] font-bold text-gray-900">
              {`${t("login.join")} ${checkRes.workspace_name}`}
            </h2>
            <p className="mt-1 text-sm text-gray-600 ">
              {`${t("login.joinTipStart")} ${checkRes.workspace_name} ${t(
                "login.joinTipEnd"
              )}`}
            </p>
          </div>
              ...
              <div className="block w-hull mt-2 text-xs text-gray-600">
                ...
                <Link
                  ...
                  href={`https://docs.dify.ai/${
                    locale === "en" ? "" : `v/${locale.toLowerCase()}`
      ...
      {checkRes && checkRes.is_valid && showSuccess && (
        <div className="flex flex-col md:w-[400px]">
          <div className="w-full mx-auto">
            ...
            <h2 className="text-[32px] font-bold text-gray-900">
              {`${t("login.activatedTipStart")} ${checkRes.workspace_name} ${t(
                "login.activatedTipEnd"
              )}`}
            </h2>
          </div>
          <div className="w-full mx-auto mt-6">
