...
const Debug: FC<IDebug> = ({ hasSetAPIKEY = true, onSetting, inputs }) => {
    ...
    sendChatMessage(appId, data, {
      ...
      async onCompleted(hasError?: boolean) {
        ...
        if (_newConversationId) {
          const { data }: any = await fetchConvesationMessages(
            appId,
            _newConversationId as string
          );
            ...
            produce(getChatList(), (draft) => {
              ...
              if (index !== -1) {
                ...
                draft[index] = {
                  ...
                  more: {
                    time: dayjs
                      .unix(newResponseItem.created_at)
                      .format("hh:mm A"),
                    tokens:
  ...
  useEffect(() => {
    if (controlClearChatMessage) setChatList([]);
  }, [controlClearChatMessage]);
    ...
    <>
      <div className="shrink-0">
        <div className="flex items-center justify-between mb-2">
          ...
          {mode === "chat" && (
            <Button
              className="flex items-center gap-1 !h-8 !bg-white"
            ...
            >
              ...
              >
                <Chat
                  ...
                  isShowSpeechToText={
                    speechToTextConfig.enabled && !!speech2textDefaultModel
                  }
