        ...
        {isChatApp && (
          ...
          >
            <>
              ...
              />
              <FeatureItem
                icon={<LightBulbIcon width="16" height="16" fill="#FF7A32" />}
                previewImgClassName="openingStatementPreview"
                title={t("appDebug.feature.openingSuggestions.title")}
                description={t(
                  "appDebug.feature.openingSuggestions.description"
                )}
                value={config.openingSuggestions}
                onChange={(value) => onChange("openingSuggestions", value)}
              />
              <FeatureItem
